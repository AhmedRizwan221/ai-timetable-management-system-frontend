...
import { updateSemester } from "../store/semester/semester";
import Button from "../components/shrared/Button";
import { useNavigate, useParams } from "react-router-dom";


export default function EditSemesters() {
    ...
    const handlerUpdateSemester = async (data) => {
        setErr("");
        try {
        ...
        <div className="min-h-screen bg-muted/30 md:py-10 md:px-4 ">
            <div className="bg-white border border-gray-200 rounded-lg ">
                <div className=" bg-card">
                    <div className="container mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8 border-b">
                        <div className="flex items-center gap-3">
                            <button
                                onClick={() => navigate('/dashboard/chairman/manage-semesters')}
                ...
                <div className="container mx-auto max-w-4xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <form onSubmit={handleSubmit(handlerUpdateSemester)}>
                        ...
                        <Button className="w-full flex justify-center items-center sm:w-auto bg-[#1D293D] text-white hover:bg-[#162131] cursor-pointer"
                            type="submit"
                        >
                            <Plus className="mr-2 h-4 w-4" />  Update Semester
                        </Button>
                    </form>
