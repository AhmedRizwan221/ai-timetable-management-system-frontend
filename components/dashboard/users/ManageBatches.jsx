...
export default function ManageBatches() {
    ...
    const { batches = [], error: batchError, totalPages, currentPage, hasPrevPage, hasNextPage, loading } = useSelector((state) => state.batch);
    ...
    const filterBatches = batches.filter((batch) =>
        batch?.batchName?.toLowerCase().includes(search.trim().toLocaleLowerCase()) ||
        batch?.department?.deptName?.toLowerCase().includes(search.trim().toLowerCase())
    )
